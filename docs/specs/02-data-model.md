...
CREATE TABLE card_suggestions (
  ...
  model_pin     text NOT NULL,                  -- settings['engine.model_pin'].model when produced; rows from an older pin are not listed

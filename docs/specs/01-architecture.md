...
| `WORKER_QUEUES` | `*` | worker | comma list of queue names this process consumes; `*` means every queue except the dedicated Laya queues `article.enrich.laya` and `analysis.process.laya` (spec 03 §2) |
| `LOG_LEVEL` | `info` | all | |

...
- **T4:**
  ...
  - Unsubscribing cancels that feed's pending/running analysis requests and keeps completed ones,
    whose frozen results still serve learning.
- **T5:**

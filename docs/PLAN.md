...
| M8-T2 | Housekeeping jobs: `house.purge-auth`, `house.reconcile`, `house.archive`, `house.purge-articles`, `house.purge-bodies`, cold bookmark compression, `house.purge-engine-calls`, `house.retire-cards`, `house.purge-users`, `house.reenrich`, `house.rematch`, `house.translate-cards` | — | B | 11 §5–6, §8; 05 §2; 07 §5 |

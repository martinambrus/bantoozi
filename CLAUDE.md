...
- 2026-09-26 — M1 Ingestion core done on branch `claude/confident-ritchie-4h136b` (`50373a3`…`8d591aa`, PR #5; see PLAN.md §6): SSRF-safe fetch client with charset decoding, canonical URL identity, feed parsing/sanitizing with fixtures, R2 media signals (video evidence, in-body image counts, media revision re-ranks), adaptive scheduling, extraction with robots and the shared origin limiter, discovery and OPML, the feed.schedule/feed.fetch/article.extract/article.capture-bookmark handlers with article and feed merges and queue retries for transient page failures, the ingestion E2E test and `pnpm worker-cli`. Deviations D-11…D-17; migrations 0009 (D-13…D-16) and 0010 (R2 media columns). Merge to `main` before M3a/M4/M5.

...
- 2026-09-26 — M1 Ingestion core done on branch `claude/confident-ritchie-4h136b` (`50373a3`…`6b2eea2`; see PLAN.md §6): SSRF-safe fetch client with charset decoding, canonical URL identity, feed parsing/sanitizing with fixtures, adaptive scheduling, extraction with robots and the shared origin limiter, discovery and OPML, the feed.schedule/feed.fetch/article.extract/article.capture-bookmark handlers with article and feed merges, the ingestion E2E test and `pnpm worker-cli`. Deviations D-11…D-16; D-13…D-16 add migration 0009. Merge to `main` before M3a/M4/M5.
